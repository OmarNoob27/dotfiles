...
export NNN_PLUG='m:nmount;i:imgview;f:fzcd;t:mp3conv;e:suedit;v:preview-tui;x:!doas chmod +x $nnn;k:pskill;s:!bash -i*;o:fzopen' #to play this plug press ; then choose option 
