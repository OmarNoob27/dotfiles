...
export NNN_BMS="m:/media/;g:$HOME/Documents/GitHub/dotfiles;d:$HOME/Downloads/;h:~;s:~/scripts;f:~/ffmpeg;C:~/cell;w:~/wallpapers;y:~/youtube-dl;t:~/.local/share/Trash/files;S:~/screenshots;c:~/.config;p:~/pins;P:~/Pictures;M:~/Music;e:~/Enterprise;v:~/Videos;k:/run/user/1000/59cda44b9f5d1bb4/;T:~/Templates" #to play this plug press b then choose option 
